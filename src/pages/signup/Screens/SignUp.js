...
import { sendOtp, verifyOTP } from "../../login/Reducers/loginSlice";
import PhoneInput from "react-phone-input-2";
import "react-phone-input-2/lib/material.css";
import { useNavigate } from "react-router-dom";
import { Copyright } from "../../login/Screens/SignIn";
...
const SignUp = () => {
  ...
  const handleChange = (e, v) => {
    ...
    if (e.target.value.length < 5) {
      setErrorMessage({
        ...errorMessage,
        otp: "minimum 5 digits OTP required",
      });
    } else {
  ...
  return (
    <Container component="main">
      ...
      >
        ...
        {!success ? (
          <Box component="form" onSubmit={handleOTPsend} sx={{ mt: 1 }}>
            <PhoneInput
              // country={'us'}
