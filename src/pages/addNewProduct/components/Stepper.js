...
import { uploadProductActions } from '../../../redux';
...
import CustomAutocomplete from '../../../components/Ui/CustomComponents/CustomAutocomplete';
import { saveProduct } from '../../../redux/reducers/uploadSlice';
import axios from 'axios';
import CustomTextField from '../../../components/Ui/CustomComponents/CustomTextField';
import { saveImg, uploadImgActions } from '../../../redux/reducers/imageUpload';
      ...
      <div>
        {allStepsCompleted() ? (
          ...
          <React.Fragment>
            ...
            {/* {activeStep === 0 && <Details getDetails={getDetails}/> } */}

            {/*Page=3 File Upload/images Tab */}
            {activeStep === 2 && 
                ...
                {/* <Grid item xs={3.5}>
                    <Stack direction="column" spacing={1} justifyContent="space-between" sx={{height:"100%"}}>
                        <Box sx={{height:"100%", width: "100%", border: "1px dashed red"}}>

                        </Box>
                        <Box sx={{height:"100%", width: "100%", border: "1px dashed red"}}></Box>
                    </Stack>
                </Grid>
                <Grid item xs={3.5}>
                    <Stack direction="column" spacing={1} justifyContent="space-between" sx={{height:"100%"}}>
